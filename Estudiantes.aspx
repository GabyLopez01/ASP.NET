...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Label ID="lbl_apellidosLabel1" runat="server" Text="Apellidos" CssClass="badge" Font-Size="Small"></asp:Label>
    <asp:TextBox ID="txt_apellidos" runat="server" CssClass="form-control" placeholder="Eje: Apell1 Apell2"></asp:TextBox>
