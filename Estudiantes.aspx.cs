...
namespace pr_web
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void btn_crear_Click(object sender, EventArgs e) {
            estudiantes = new Estudiantes();
            if (estudiantes.crear(txt_carne.Text, txt_nombres.Text, txt_apellidos.Text, txt_direccion.Text, txt_telefono.Text, txt_correo_electronico.Text, drop_tipo_sangre.SelectedValue, txt_fn.Text) > 0) {
        ...
        protected void grid_estudiantes_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txt_fn.Text = fecha_nacimiento.ToString("yyyy-MM-dd");
        }
        ...
        {
            estudiantes = new Estudiantes();
            if (estudiantes.actualizar(Convert.ToInt32(grid_estudiantes.SelectedValue) ,txt_carne.Text, txt_nombres.Text, txt_apellidos.Text, txt_direccion.Text, txt_telefono.Text, txt_correo_electronico.Text, drop_tipo_sangre.SelectedValue, txt_fn.Text) > 0) 
            {
